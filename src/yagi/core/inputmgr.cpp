...
InputMgr::InputMgr() {
  ...
  Bus::subscribe(msg_endpoint_id_, MsgType::Key);
  Bus::subscribe(msg_endpoint_id_, MsgType::CursorPos);
  Bus::subscribe(msg_endpoint_id_, MsgType::CursorEnter);
  Bus::subscribe(msg_endpoint_id_, MsgType::MouseButton);
  Bus::subscribe(msg_endpoint_id_, MsgType::Scroll);
...
void InputMgr::received_msg_(const Msg &msg) {
